...
namespace PathfinderCharacterGeneration
{
    public class Startup
    {
        ...
        {
            // Redirect any non-API calls to the Angular applicatoin
            ...
            // Configures applicatoin to serve the index.html file from /wwwroot
